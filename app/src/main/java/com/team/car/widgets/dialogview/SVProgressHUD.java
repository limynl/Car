...
public class SVProgressHUD {
    ...
    public static void showWithMaskType(Context context, boolean flag) {
    ...
    public static void isCancel(Context context, boolean flag){
        if (flag){
            getInstance(context).scheduleDismiss();
        }
    }
    ...
    public static void showInfoWithStatus(Context context,String string, boolean flag) {
        getInstance(context).setMaskType(SVProgressHUDMaskType.Black);
    ...
    public static void showSuccessWithStatus(Context context,String string, boolean flag) {
        getInstance(context).setMaskType(SVProgressHUDMaskType.Black);
    ...
    public static void showErrorWithStatus(Context context,String string, boolean flag) {
        getInstance(context).setMaskType(SVProgressHUDMaskType.Black);
